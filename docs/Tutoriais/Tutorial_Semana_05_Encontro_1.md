...
- Um mesh simples para representar a porta (pode ser um `MeshInstance3D` com `BoxMesh`, ou um asset do Kenney Mini Dungeon, importado em `assets/dungeon/` desde a Semana 1 — Tutorial - Semana 1, Encontro 1, Parte 4).
